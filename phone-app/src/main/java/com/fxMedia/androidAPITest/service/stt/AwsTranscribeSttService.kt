...
import com.fxMedia.androidAPITest.service.SpeechErrorCode
...
import com.fxMedia.androidAPITest.service.stt.mapHttpStatusToError
...
class AwsTranscribeSttService(
    ...
    private fun createTranscribeListener(
        ...
        continuation: CancellableContinuation<SpeechResult>
    ): WebSocketListener {
