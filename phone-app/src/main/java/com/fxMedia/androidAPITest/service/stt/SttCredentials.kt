...
data class SttCredentials(
    // Currently selected STT provider - Defaulting to Azure Speech
    val selectedProvider: String = SttProvider.AZURE_SPEECH.name,
    ...
    val azureSpeechKey: String = "9gc9wRV6NllAZLejnO9Ua79H9osunQaPl7e1syWfglQ1siZqgYHcJQQJ99AKACqBBLyXJ3w3AAAYACOGVFeJ",
    val azureSpeechRegion: String = "southeastasia",
    ...
    fun getSelectedProvider(): SttProvider {
        return SttProvider.fromName(selectedProvider)
    }
