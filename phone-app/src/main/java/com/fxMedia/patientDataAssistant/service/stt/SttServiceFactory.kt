...
import com.fxMedia.patientDataAssistant.data.ApiSettings
...
private class GeminiSttAdapter(
    ...
    private val geminiService by lazy {
        com.fxMedia.patientDataAssistant.service.ai.GeminiService(apiKey, modelId)
    }
...
private class OpenAiWhisperSttAdapter(
    ...
    private val openAiService by lazy {
        com.fxMedia.patientDataAssistant.service.ai.OpenAiCompatibleService(
            apiKey = apiKey,
