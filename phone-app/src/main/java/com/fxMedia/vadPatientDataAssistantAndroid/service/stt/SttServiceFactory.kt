...
import com.fxMedia.vadPatientDataAssistantAndroid.data.ApiSettings
...
private class GeminiSttAdapter(
    ...
    private val geminiService by lazy {
        com.fxMedia.vadPatientDataAssistantAndroid.service.ai.GeminiService(apiKey, modelId)
    }
...
private class OpenAiWhisperSttAdapter(
    ...
    private val openAiService by lazy {
        com.fxMedia.vadPatientDataAssistantAndroid.service.ai.OpenAiCompatibleService(
            apiKey = apiKey,
