package com.fxMedia.vadPatientDataAssistantAndroid.viewmodel
...
import com.fxMedia.vadPatientDataAssistantAndroid.api.RetrofitClient
import com.fxMedia.vadPatientDataAssistantAndroid.api.model.TestRequest
import com.fxMedia.vadPatientDataAssistantAndroid.data.TokenManager
import com.fxMedia.vadPatientDataAssistantAndroid.data.SettingsRepository
import com.fxMedia.vadPatientDataAssistantAndroid.service.BluetoothConnectionState
import com.fxMedia.vadPatientDataAssistantAndroid.service.BluetoothSppManager
import com.fxMedia.vadPatientDataAssistantAndroid.service.SpeechResult
import com.fxMedia.vadPatientDataAssistantAndroid.service.TextToSpeechService
import com.fxMedia.vadPatientDataAssistantAndroid.service.stt.SttCredentialsRepository
import com.fxMedia.vadPatientDataAssistantAndroid.service.stt.SttService
import com.fxMedia.vadPatientDataAssistantAndroid.service.stt.SttServiceFactory
import com.fxMedia.vadPatientDataAssistantAndroid.service.stt.SttValidationResult
import com.fxMedia.vadPatientDataAssistantAndroid.data.log.LogManager
...
data class PhoneUiState(
    ...
    val logs: List<com.fxMedia.vadPatientDataAssistantAndroid.data.log.LogEntry> = emptyList(),
...
class PhoneViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val cxrManager = com.fxMedia.vadPatientDataAssistantAndroid.service.cxr.CxrMobileManager(application)
    private val elevenLabsLiveService = com.fxMedia.vadPatientDataAssistantAndroid.service.ai.ElevenLabsLiveService(application)
    private val vadLiveService = com.fxMedia.vadPatientDataAssistantAndroid.service.ai.VadLiveService(application) { audioData ->
    ...
    init {
        ...
        viewModelScope.launch {
            cxrManager.bluetoothState.collect { state ->
                when (state) {
                    is com.fxMedia.vadPatientDataAssistantAndroid.service.cxr.CxrMobileManager.BluetoothState.Connected -> {
                    ...
                    is com.fxMedia.vadPatientDataAssistantAndroid.service.cxr.CxrMobileManager.BluetoothState.Failed -> {
    ...
    private fun updateSttService() {
        ...
        if (sttService?.provider == com.fxMedia.vadPatientDataAssistantAndroid.service.stt.SttProvider.AZURE_SPEECH) {
            checkAzureStatus()
        }
    }
