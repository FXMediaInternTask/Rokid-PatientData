...
import com.fxMedia.androidAPITest.testutil.MockWebServerRule
import com.fxMedia.androidAPITest.testutil.TestFixtures
...
class AnthropicServiceTest {
    ...
    fun `provider returns ANTHROPIC`() {
        val service = createService()
        assertThat(service.provider).isEqualTo(com.fxMedia.androidAPITest.data.AiProvider.ANTHROPIC)
    }
