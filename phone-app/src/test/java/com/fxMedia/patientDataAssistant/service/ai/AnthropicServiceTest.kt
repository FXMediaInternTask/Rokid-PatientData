...
import com.fxMedia.patientDataAssistant.testutil.MockWebServerRule
import com.fxMedia.patientDataAssistant.testutil.TestFixtures
...
class AnthropicServiceTest {
    ...
    fun `provider returns ANTHROPIC`() {
        val service = createService()
        assertThat(service.provider).isEqualTo(com.fxMedia.patientDataAssistant.data.AiProvider.ANTHROPIC)
    }
