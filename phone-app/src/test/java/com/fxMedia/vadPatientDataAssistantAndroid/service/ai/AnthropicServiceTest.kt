...
import com.fxMedia.vadPatientDataAssistantAndroid.testutil.MockWebServerRule
import com.fxMedia.vadPatientDataAssistantAndroid.testutil.TestFixtures
...
class AnthropicServiceTest {
    ...
    fun `provider returns ANTHROPIC`() {
        val service = createService()
        assertThat(service.provider).isEqualTo(com.fxMedia.vadPatientDataAssistantAndroid.data.AiProvider.ANTHROPIC)
    }
